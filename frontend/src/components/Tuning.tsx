...
export default function Tuning({ ex }: { ex: UseExplain }) {
  ...
  return (
    <div className="bg-panel border border-line rounded-xl p-3 flex flex-col gap-3 max-h-[640px] overflow-y-auto">
      ...
      {GROUPS.map((g) => (
        <div key={g}>
          <div className="text-[11px] font-semibold text-[#c7ccd8] mb-1.5">{g}</div>
